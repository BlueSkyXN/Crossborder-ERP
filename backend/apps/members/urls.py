...
urlpatterns = [
    ...
    path("auth/password-reset/request", PasswordResetRequestView.as_view(), name="member-password-reset-request"),
    path("auth/password-reset/confirm", PasswordResetConfirmView.as_view(), name="member-password-reset-confirm"),
