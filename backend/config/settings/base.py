...
MEMBER_PASSWORD_RESET_TOKEN_TTL_MINUTES = env.int("MEMBER_PASSWORD_RESET_TOKEN_TTL_MINUTES", default=30)
MEMBER_PASSWORD_RESET_EXPOSE_TOKEN = env.bool("MEMBER_PASSWORD_RESET_EXPOSE_TOKEN", default=DEBUG)
