...
- `ai-dev-baseline/`：原始 AI 开发基线包，作为需求和任务来源。
- `implementation-decisions.md`：本项目已经锁定的实施选型和隔离策略。
- `ai-development-proof.md`：AI 驱动开发证明口径、人工介入边界和证据要求。
- `deployment/README.md`：no-Docker local-first 部署说明、staging 边界、文件存储和 FAQ。
